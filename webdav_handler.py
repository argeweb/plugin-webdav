...
import logging
import os
from models.webdav_model import WebdavModel as Resource, WebdavResourceData
...
class WebDAVHandler(webapp2.RequestHandler):
    def initialize(self,request,response):
        ...
        host = get_host_information_item(server_name)
        namespace_manager.set_namespace(host.namespace)
    ...
    def put(self):
        ...
        data = WebdavResourceData(blob=self.request.body)
        data.put()
